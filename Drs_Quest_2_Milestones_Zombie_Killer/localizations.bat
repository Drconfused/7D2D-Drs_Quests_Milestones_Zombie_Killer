...
echo.
for %%I in (.) do set CurrDirName=%%~nxI
echo This will load up the localization data for the mod "Drs_Milestones_Zombie_Killer".
echo.
...
FINDSTR /v "Paper_Mile Quest_Chit --Drs_Milestones_Zombie_Killer" LocalizationTEMP.txt > "../../data/config/Localization.txt"
